...
export const metadata = {
  ...
  openGraph: {
    title: "BawdicSoft",
    description: "Generated by BawdicSoft",
    url: "https://bawdicsoft-new-website.vercel.app/nft-marketplace-development",
    siteName: "Sigmantarian",
    images: [
      {
        url: "https://bawdicsoft-new-website.vercel.app/nft-marketplace-development/opengraph-image.jpg",
        width: 1200,
        height: 630,
        alt: "BawdicSoft"
      }
  ...
  twitter: {
    ...
    title: "BawdicSoft",
    description: "Generated by BawdicSoft",
    images: ["https://bawdicsoft-new-website.vercel.app/nft-marketplace-development/twitter-image.jpg"]
  }
};
