      ...
      {productOneDetail.Video && (
        <div className="flex max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 content-center">
            ...
            <div className="p-5 mx-auto pt-8 px-8 md:pt-16 md:px-16">
              <video
                className="w-full h-auto border border-gray-500 rounded-md shadow-xl shadow-gray-700"
                autoPlay
                controls
              >
                <source src={productOneDetail.Video} type="video/mp4" />
            ...
            {/* Text section */}
            <div className="flex flex-col justify-center pt-16 pb-10 md:pb-8 bg-gray-100 pr-5">
              <p className="text-2xl md:text-3xl font-bold px-10 lg:px-0">
                {productOneDetail.mainTitle}
              </p>

              <p className="text-md px-10 md:pl-10 lg:pl-0 md:pr-10 pt-5">
                {productOneDetail.projectDesc}
              </p>
              ...
              {productOneDetail.foodRecognization && (
                <div className="pl-10 pr-10 lg:pl-0 lg:pr-0 pt-5">
                  <b className="text-md font-bold">
                    {productOneDetail.foodRecognization}
                  </b>
