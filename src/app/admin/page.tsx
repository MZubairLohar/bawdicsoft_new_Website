...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    async function fetchDashboardData() {
      try {
        // 🔥 FIX 1: Added credentials: 'include' and safe JSON parsing
        ...
        // 🔥 FIX 2: Added credentials and safe parsing for analytics
        ...
        // 🔥 FIX 3: Added credentials and safe parsing for companies (tracker)
  ...
  const handleAddToCRM = async (companyName: string) => {
    ...
    try {
      // 🔥 FIX 4: Added credentials: 'include' in POST request
      const res = await fetch('/api/admin/leads', {
       ...
       body: JSON.stringify({
  name: companyName,
  email: 'no-email@companytracker.local', // 🔥 Yeh add karein
  ...
  message: `Auto-captured from Company Tracker.`,
      ...
      if (res.ok) {
        ...
        // 🔥 FIX 5: Changed endpoint from /api/admin/companies to /api/track to match the tracker fetch
