    ...
    <div className="space-y-6 max-w-[1600px] mx-auto">
      ...
      >
        ...
        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="inline-flex items-center gap-2 text-sm font-semibold bg-white/10 backdrop-blur-sm ring-1 ring-white/20 rounded-xl px-4 py-3">
          ...
          return (
            ...
            >
              <div className="relative bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group">
                <div
                  className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${tile.gradient}`}
                />
                <div className="flex items-start justify-between mb-3">
                  <div
                    className={`p-2.5 rounded-xl bg-gradient-to-br ${tile.gradient} text-white shadow-sm group-hover:scale-110 transition-transform`}
                  >
      ...
      >
        <div className="flex gap-2 flex-wrap">
          {["All", "New", "Contacted", "Closed"].map((filterName) => {
            ...
            return (
              ...
              >
                <span
                  className={`w-2 h-2 rounded-full ${isActive ? theme.dot : "bg-gray-300"}`}
                />
                {filterName}
                <span
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 bg-white text-sm focus:ring-2 focus:ring-sky-500/30 focus:border-sky-500 outline-none transition-all shadow-sm"
          />
        </div>
      </motion.div>
                ...
                <div className="flex items-center justify-between relative">
                  <div>
                    ...
                    <p className="text-sm text-white/70 mt-1">
                      Received on {formatDate(selectedLead.createdAt)} via{" "}
                      {selectedLead.source}
                    </p>
                  </div>
                  <span
              ...
              <div className="p-6 md:p-8 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100">
                  <a
                    ...
                    className="flex-1 bg-gradient-to-r from-sky-600 to-blue-700 hover:from-sky-700 hover:to-blue-800 text-white text-center py-2.5 rounded-xl font-semibold text-sm transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                  >
                  ...
                  {selectedLead.phone && (
                    <a
                      ...
                      className="flex-1 bg-gradient-to-r from-emerald-600 to-green-700 hover:from-emerald-700 hover:to-green-800 text-white text-center py-2.5 rounded-xl font-semibold text-sm transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                    >
