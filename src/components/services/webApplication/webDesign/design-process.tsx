  ...
  const processSteps = [
    {
      ...
      description: "Comprehensive analysis of your business goals, target audience, and technical requirements.",
      icon: (
    ...
    {
      title: "Wireframing",
      description: "Structural blueprints that define user flows and information architecture.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "UI/UX Design",
      description: "Beautiful, intuitive interfaces with pixel-perfect attention to detail.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Development",
      description: "Robust, scalable code implementation using modern technologies.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            A transparent workflow from concept to launch
          </p>
        </div>
            ...
            >
              <div className="p-8">
                ...
                <div className="flex items-center">
                  <div className={`h-2 w-8 rounded-full ${step.color} bg-opacity-30 mr-2`}></div>
