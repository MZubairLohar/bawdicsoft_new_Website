...
interface GetInTouchWithUsProps {}

const GetInTouchWithUs: FC<GetInTouchWithUsProps> = () => {
  return (
 ...
 <p className="text-white text-md py-3 text-center">Ready to transform your ideas into reality? Partner with BawdicSoft to leverage the power of AI, blockchain, web, and mobile technologies. Contact us today to discuss your project and take the first step toward a brighter, tech-driven future.</p>
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  md:px-12 max-w-7xl gap-5 pt-5 md:pt-10">
  ...
  <svg className="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
    ...
    <p className="text-gray-700">+92317-8866631</p>
    </div>
  </div>
  <div className="p-5 md:p-8 flex rounded-3xl bg-white">
  <div className="bg-sky-950 p-5  flex justify-center items-center w-16 h-16  rounded-full">
  <svg className="w-6 h-6  text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
    ...
    <div className="pl-2">
    <h2 className="text-green font-bold text-2xl  md:text-3xl ">Email Us</h2>
    <p className="text-gray-700">info@bawdicsoft.com</p>
    </div>
  </div>
 </div>
    {/* sign up form */}
   ...
   <h4 className="text-2xl  md:text-3xl font-semibold text-center">Sign Up for Our Newsletter</h4>
   <p className="text-gray-800 text-center">Stay updated on the latest career opportunities, company news, and industry trends at BawdicSoft! Subscribe to our newsletter to receive exclusive insights, job openings, and tips for thriving in the tech world. Join our community of innovators and take the first step toward a rewarding career.</p>
