...
import lockImg from "../../../public/images/ai-pic.webp";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 pt-10 md:gap-20">
          <div className="flex flex-col self-center">
            ...
            <p className="mb-4 text-start leading-7 tracking-tight text-white">
              ...
              automate processes, enhance decision-making, and unlock valuable
              insights from data. Our AI expertise covers Machine Learning,
              Natural Language Processing (NLP), Computer Vision, and predictive
              analytics.
            </p>

            <p className="mb-4 text-start leading-7 tracking-tight text-white">
              From AI chatbots and recommendation systems to data analysis and
              automation tools, we build smart systems that improve efficiency,
              reduce manual work, and create innovative digital experiences for
              your users.
            </p>
          </div>
